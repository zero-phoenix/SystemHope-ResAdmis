...
Precisión resolutiva: el ordinal de medios probatorios debe mencionar las fechas exactas del escrito de denuncia y su subsanación. El ordinal de traslado se rige por la fórmula literal canónica R-155 (desde v3.5, R-212: traslado **de la denuncia del …**, con la cita completa del ordinal de admisión, apercibimiento de rebeldía y cita al artículo 223 del TUO de la LPAG). No se presuponen SEGUNDO/CUARTO: se conservan los ordinales previos de inadmisibilidad, confidencialidad o incorporación de partes.
