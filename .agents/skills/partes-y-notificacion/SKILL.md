...
## Traslado (literal; R-155 y R-209)
...
- La cita de la denuncia es **la misma del artículo que la admite** (PRIMERO): denuncia, subsanaciones y complementos, con sus fechas. Nunca «de la presente resolución» (v3.4, instructor 24/09/2026). El constructor la sincroniza con la del PRIMERO y el verificador rechaza la que difiera.
