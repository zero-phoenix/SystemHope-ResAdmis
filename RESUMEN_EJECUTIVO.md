...
- **Firma vigente en todas las plantillas** (427 bloques normalizados).
- **Nuevas reglas con falsador**: números sin «N°» (R-156), sin «denunciante» en los hechos (R-157), enmascarado (R-158), nota al pie del traslado a CC1 (R-159), fechas «de AAAA» y «recibida» (R-161).
